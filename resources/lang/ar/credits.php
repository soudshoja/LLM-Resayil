...
return [
    ...
    'credit_based_billing' => 'الفوترة القائمة على الاعتمادات',
    'credit_description' => 'تستخدم منصتنا نظام فوترة قائماً على الاعتمادات. يتم خصم الاعتمادات بناءً على عدد الرموز المعالجة في طلبات API الخاصة بك.',
    'local_models' => 'النماذج المحلية',
    'local_description' => 'نماذج تعمل على خادم GPU الخاص بنا. التكلفة: 1 اعتماد لكل 1000 رمز.',
    'cloud_models' => 'النماذج السحابية',
    'cloud_description' => 'نماذج تعمل عبر ollama.com. التكلفة: 2 اعتماد لكل 1000 رمز.',
    'credit_tiers' => 'تكاليف الاعتمادات حسب نوع النموذج',
    ...
    'local' => 'محلي',
    'cloud' => 'سحابي',
    'estimated_credits' => 'الاعتمادات المقدّرة',
    'example_calculation' => 'مثال على الحساب',
    'example_text' => 'طلب بـ 500 رمز إدخال و150 رمز إخراج باستخدام نموذج محلي سيكلف:',
    'example_result' => '(500 + 150) × 1 = 650 اعتماداً',
    'example_result_cloud' => '(500 + 150) × 2 = 1,300 اعتماد',
    'check_balance' => 'التحقق من رصيدك',
    'check_balance_text' => 'اطّلع على رصيدك المتبقي وسجل الاستخدام في لوحة التحكم.',
