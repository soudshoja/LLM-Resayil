...
<main>
    ...
    <div class="card" style="margin-bottom:1.5rem">
        ...
        $tierModels = [
            ...
            'enterprise' => [['id'=>'llama3.2:3b','desc'=>'Fast · 3B · General'],['id'=>'smollm2:135m','desc'=>'Ultra-fast · 135M'],['id'=>'qwen2.5-coder:14b','desc'=>'Code · 14B'],['id'=>'mistral-small3.2:24b-instruct-2506-q4_K_M','desc'=>'Balanced · 24B'],['id'=>'glm-4.7-flash:latest','desc'=>'High quality · 30B'],['id'=>'qwen3-30b-40k:latest','desc'=>'Long context 40K · 30B'],['id'=>'gpt-oss:20b','desc'=>'OpenAI OSS · 20B'],['id'=>'hf.co/Qwen/Qwen3-VL-32B-Instruct-GGUF:Q4_K_M','desc'=>'Vision + text · 32B'],['id'=>'deepseek-v3.1:671b','desc'=>'Cloud · 671B · DeepSeek'],['id'=>'deepseek-v3.2','desc'=>'Cloud · DeepSeek v3.2'],['id'=>'qwen3.5:397b','desc'=>'Cloud · 397B · Qwen'],['id'=>'devstral-2:123b','desc'=>'Cloud · 123B · Devstral']],
        ];
